...
|   └── rpm-building                              "Tool for automatically building spec and creating PR"
|   |   └── build-image.sh                        "Script for build package building env based openEuler"
|   |   └── Dockerfile                            "Dockerfile for build package building env based openEuler"
|   |   └── openEuler.repo                        "RPM repo configuration for openeuler pkg building env"
|   |   └── openeuler_pkg.py                      "Python script for building spec and creating PR in batch"
