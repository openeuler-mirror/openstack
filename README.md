...
|   └── rpm-building                              "自动化批量构建spec和创建PR的工具"
|   |   └── build-image.sh                        "用于构建打包环境的Docker镜像的脚本"
|   |   └── Dockerfile                            "用于构建打包环境的Dockerfile"
|   |   └── openEuler.repo                        "用于创建打包环境的RPM仓库配置"
|   |   └── openeuler_pkg.py                      "批量化创建spec和提交PR的python脚本"
